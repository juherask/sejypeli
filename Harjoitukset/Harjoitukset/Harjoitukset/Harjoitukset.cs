...
class Harjoitukset : Tarkistaja
{
    public override int Tehtava1(int a, int b)
    {
        ...
        int c = 0; // TODO: Kirjoita koodi tämän kommentin tilalle
        return c;
    }
    ...
    public override double Tehtava2(double x, double y, double z)
    {
        ...
        double keskiarvo = 0.0; // TODO: Kirjoita koodi tämän kommentin tilalle
        return keskiarvo ;
    }
    ...
    public override void Tehtava3()
    {
        ...
        // TODO: Kirjoita koodi tämän kommentin tilalle
    }
